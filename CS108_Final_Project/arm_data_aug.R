...
m2    <- read_monthly("armenia_M2.xlsx",                   "M2")               
bot   <- read_monthly("armenia_balance_of_trade.xlsx",     "balance_of_trade") 
infl  <- read_monthly("armenia_long_run_inflation_rate.xlsx",  "inflation_rate")
refi  <- read_monthly("armenia_short_term_interest_rate.xlsx","refinancing_rate")
unemp <- read_monthly("armenia_unemployment_rate.xlsx",    "unemployment_rate")

gdp <- read_excel("armenia_GDP.xlsx",
...
fx_monthly <- read_csv("usd_exchange_rate.csv",
                       col_types = cols(
